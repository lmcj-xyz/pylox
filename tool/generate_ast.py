...
class GenerateAst():
    def define_ast(self, output_dir: str, base_name: str, types: list[str]):
        ...
        self.define_visitor("visitor", base_name, types)
        with open(path, "w", encoding="utf-8") as file:
            file.write("from token import Token\n")
            file.write("from visitor import Visitor\n")
            file.write("\n\n")
    ...
    def define_visitor(self, file_name: str, base_name: str, types: list[str]):
        path: str = output_dir + "/" + file_name + ".py"
        with open(path, "w", encoding="utf-8") as file:
    ...
    def define_type(self, file, base_name: str, class_name: str, field_list: str):
        ...
        file.write(
                "        return visitor.visit_" + class_name.lower()
